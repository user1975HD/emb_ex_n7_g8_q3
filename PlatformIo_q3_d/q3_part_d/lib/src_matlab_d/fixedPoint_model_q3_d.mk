###########################################################################
## Makefile generated for component 'fixedPoint_model_q3_d'. 
## 
## Makefile     : fixedPoint_model_q3_d.mk
## Generated on : Sat Dec 26 21:32:32 2020
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/fixedPoint_model_q3_d.elf
...
PRODUCT_NAME              = fixedPoint_model_q3_d
MAKEFILE                  = fixedPoint_model_q3_d.mk
MATLAB_ROOT               = E:/Program Files/Matlab 2020/Polyspace/R2020b
MATLAB_BIN                = E:/Program Files/Matlab 2020/Polyspace/R2020b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = I:/Slides/Embeded Systems/Embeded HWs/Embeded HW7/Mathlab_Stuff
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/FARIDO~1/DOCUME~1/MATLAB/R2020b/ARDUIN~1/ARDUIN~2/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/fixedPoint_model_q3_d.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=5 -DMW_PRESCALAR=8 -DMW_TIMERCOUNT=65490 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=fixedPoint_model_q3_d -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = fixedPoint_model_q3_d.o fixedPoint_model_q3_d_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/fixedPoint_model_q3_d_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/fixedPoint_model_q3_d_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/fixedPoint_model_q3_d_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/fixedPoint_model_q3_d_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


fixedPoint_model_q3_d.o : $(START_DIR)/fixedPoint_model_q3_d_ert_rtw/fixedPoint_model_q3_d.c
	$(CC) $(CFLAGS) -o "$@" "$<"


fixedPoint_model_q3_d_data.o : $(START_DIR)/fixedPoint_model_q3_d_ert_rtw/fixedPoint_model_q3_d_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
